...
class CountriesRemoteDataSource @Inject constructor(private val countriesRestAdapter: CountriesRestAdapter) :
    ...
    fun getCountriesFromRemoteDataSourceAndMap(): Single<ViewObject<List<Country>>> =
    ...
    fun getCountryByAlphaFromRemoteDataSource(alpha: String): Flowable<ViewObject<Country>> =
